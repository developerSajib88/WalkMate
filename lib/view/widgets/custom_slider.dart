  ...
  Widget build(BuildContext context) {
    return SliderTheme(
      data: SliderTheme.of(context).copyWith(
          ...
          trackShape: GradientSliderTrackShape(linearGradient: widget.linearGradient),
          trackHeight: widget.trackHeight,
          showValueIndicator: ShowValueIndicator.always,
          valueIndicatorColor: Colors.transparent,
          valueIndicatorTextStyle: GoogleFonts.manrope(fontSize: 14,fontWeight: FontWeight.bold, color: AppColor.green),
      ...
      child: SizedBox(width: double.infinity,
        child: GetBuilder<TargetLimitController>(
          builder: (_) {
            return Slider(
              min: widget.min,
              max: widget.max,
              divisions: widget.divisions,
              label: "${targetLimitController.targetLimit.toInt().toString()}m",
              onChanged: (double value) {
                setState(() {
                  targetLimitController.setTarget(value);
                });
              },
              value: targetLimitController.targetLimit,
            );
          }
        ),
      ),
